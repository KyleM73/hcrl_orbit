...
from orbit.hcrl.tasks.locomotion.mdp.pnc.interface import Interface
from orbit.hcrl.tasks.locomotion.mdp.pnc.draco3_pnc.draco3_interrupt_logic import Draco3InterruptLogic
from orbit.hcrl.tasks.locomotion.mdp.pnc.draco3_pnc.draco3_state_provider import Draco3StateProvider
from orbit.hcrl.tasks.locomotion.mdp.pnc.draco3_pnc.draco3_state_estimator import Draco3StateEstimator
from orbit.hcrl.tasks.locomotion.mdp.pnc.draco3_pnc.draco3_control_architecture import Draco3ControlArchitecture
from orbit.hcrl.tasks.locomotion.mdp.pnc.data_saver import DataSaver
...
class Draco3Interface(Interface):
    def __init__(self):
        ...
        if PnCConfig.DYN_LIB == "pinocchio":
            from orbit.hcrl.tasks.locomotion.mdp.pnc.robot_system.pinocchio_robot_system import PinocchioRobotSystem
