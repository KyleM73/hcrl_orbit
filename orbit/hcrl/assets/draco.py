...
DRACO_CFG = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            "[lr]_hip_ie.*" : 0.000,
            "l_hip_aa.*" : 0.087, #0.160,
            "r_hip_aa.*" : -0.087, #-0.160,
            "[lr]_hip_fe.*" : -0.785, #-1.1, #-0.785,
            "[lr]_knee_fe_jp.*" : 0.785,
            "[lr]_knee_fe_jd.*" : 0.785, #1.1, #0.785,
            "[lr]_ankle_fe.*" : -0.785, #-1.1, #-0.785,
            "l_ankle_ie.*" : -0.087, #-0.160,
            "r_ankle_ie.*" : 0.087, #0.160,
    ...
    actuators={
        "pitch": ActuatorCfg(
            ...
            velocity_limit=76.0,
            stiffness={
                "neck_pitch.*": 0.0, #40.0, #15.0,
                "[lr]_wrist_pitch.*": 0.0, #50.0, #7.0,
            },
            damping={
                "neck_pitch.*": 0.0, #2.0, #0.0,
                "[lr]_wrist_pitch.*": 0.0, #3.0, #0.07,
            },
            friction={
                "neck_pitch.*": 0.0,
                "[lr]_wrist_pitch.*": 0.0
         ...
         "shoulder": ActuatorCfg(
            ...
            velocity_limit=47.0,
            stiffness={
                "[lr]_shoulder_fe.*": 0.0, #100.0, #250.0,
                "[lr]_shoulder_aa.*": 0.0, #100.0, #300.0,
                "[lr]_shoulder_ie.*": 0.0, #100.0, #60.0,
            },
            damping={
                "[lr]_shoulder_fe.*": 0.0, #8.0, #3.0,
                "[lr]_shoulder_aa.*": 0.0, #8.0, #3.0,
                "[lr]_shoulder_ie.*": 0.0, #8.0, #2.0,
            },
            friction={
                "[lr]_shoulder.*": 0.0,
            },
        ...
        "elbow": ActuatorCfg(
            ...
            velocity_limit=59.2,
            stiffness={
                "[lr]_elbow_fe.*": 0.0, #50.0, #100.0,
            },
            damping={
                "[lr]_elbow_fe.*": 0.0, #3.0, #1.2,
            },
            friction={
                "[lr]_elbow_fe.*": 0.0,
            },
        ...
        "wrist": ActuatorCfg(
            ...
            velocity_limit=71.0,
            stiffness={
                "[lr]_wrist_ps.*": 0.0, #40.0, #15.0,
            },
            damping={
                "[lr]_wrist_ps.*": 0.0, #2.0, #1.0,
            },
            friction={
                "[lr]_wrist_ps.*": 0.0,
            },
        ...
        "hip_ie_ankle_fe": ActuatorCfg(
            ...
            velocity_limit=8.1,
            stiffness={
                "[lr]_hip_ie.*": 0.0, #150.0,
                "[lr]_ankle_fe.*": 0.0, #200.0, #150.0,
            },
            damping={
                "[lr]_hip_ie.*": 0.0, #1.0,
                "[lr]_ankle_fe.*": 0.0, #2.0, #0.2,
            },
            friction={
                "[lr]_hip_ie.*": 0.0,
                "[lr]_ankle_fe.*": 0.0,
        ...
        "knee_fe": ActuatorCfg(
            joint_names_expr=["[lr]_knee_fe_jp"],
            effort_limit=40.85,
            velocity_limit=13.35,
            stiffness={
                "[lr]_knee_fe_jp": 0.0, #450.0, #450.0, # right: 450 difference from hardware
            },
            damping={
                "[lr]_knee_fe_jp": 0.0, #5.0, #1.5,
            },
            friction={
                "[lr]_knee_fe_jp": 0.0,
            },
        ...
        "ankle_ie": ActuatorCfg(
            ...
            velocity_limit=11.1,
            stiffness={
                "[lr]_ankle_ie.*": 0.0, #30.0,
            },
            damping={
                "[lr]_ankle_ie.*": 0.0, #0.1,
            },
            friction={
                "[lr]_ankle_ie.*": 0.0,
            },
